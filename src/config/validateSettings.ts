...
function validateTopLevelFields(value: Record<string, unknown>, errors: SettingsValidationError[]) {
  rejectExtraKeys(value, ['schemaVersion', 'defaultNamespace', 'language', 'initialTailLines', 'bufferLimit', 'logSources', 'shortcuts', 'logPolicyId', 'logPolicy', 'workbench'], 'settings', errors)
