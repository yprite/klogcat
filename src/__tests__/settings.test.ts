...
describe('settings validation', () => {
  ...
  it('validates AWS VM target plugin settings', () => {
    ...
    expect(validateSettings({ ...defaultSettings, targetPlugins: { awsVm: { ...enabled, bastionPasswordEnv: 'bad-name' } } })).toContainEqual(expect.objectContaining({ field: 'targetPlugins.awsVm.bastionPasswordEnv' }))
    ...
    expect(validateSettings({ ...defaultSettings, targetPlugins: { awsVm: { ...enabled, bastionPasswordMode: 'password-plus-totp', bastionTotpSecretEnv: '' } } })).toContainEqual(expect.objectContaining({ field: 'targetPlugins.awsVm.bastionTotpSecretEnv' }))
